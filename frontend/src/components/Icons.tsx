...
export function HomeIcon({ size = 24, className, fill }: IconProps) {
  return (
...
export function HomeFilledIcon({ size = 24, className, fill }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill={fill || "currentColor"} stroke="none" className={className}>
...
export function SendMessageIcon({ size = 18, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export function FoodIcon({ size = 24, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" className={className}>
      ...
      <ellipse cx="12" cy="18" rx="4" ry="2" stroke="currentColor" />
...
export function PartyIcon({ size = 24, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" className={className}>
      ...
      <path d="M12 4v1" /><path d="M16 6l-1 1" /><path d="M19 10l-1 1" />
      <path d="M12 20v-1" /><path d="M8 18l1-1" /><path d="M5 14l1-1" />
      <path d="M9 11l2 2 4-4" />
    </svg>
  );
}

export function EmptyChatIcon({ size = 48, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z" />
    </svg>
...
export function EmptyBookmarkIcon({ size = 48, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M19 21l-7-5-7 5V5a2 2 0 012-2h10a2 2 0 012 2z" />
    </svg>
...
export function EmptyRecipeIcon({ size = 48, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" className={className}>
